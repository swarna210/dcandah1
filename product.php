...
<!-- container //  -->
         ...
         <?php
			...
			$sql = "SELECT * FROM products WHERE place='".$p."' and category='".$c."' ORDER BY id ";
...
<option value="food">Food & Snacks</option>
    ...
    <option value="pookkattupadi">Pookkattupadi</option>   
        ...
        <?php  
	$query = $db->query("SELECT * FROM products WHERE place='".$p."' and category='".$c."' ORDER BY id DESC LIMIT 6");
     if($query->num_rows > 0){ 
